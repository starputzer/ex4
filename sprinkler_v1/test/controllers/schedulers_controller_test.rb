...
class SchedulersControllerTest < ActionController::TestCase
  ...
  test "should create scheduler" do
    assert_difference('Scheduler.count') do
      post :create, scheduler: { endtime: @scheduler.endtime, outputdeviceid: @scheduler.outputdeviceid, starttime: @scheduler.starttime }
    end
  ...
  test "should update scheduler" do
    patch :update, id: @scheduler, scheduler: { endtime: @scheduler.endtime, outputdeviceid: @scheduler.outputdeviceid, starttime: @scheduler.starttime }
    assert_redirected_to scheduler_path(assigns(:scheduler))
  end
