...
class SystemsControllerTest < ActionController::TestCase
  ...
  test "should create system" do
    assert_difference('System.count') do
      post :create, system: { maxoutputdevice: @system.maxoutputdevice, systemode: @system.systemode, systemtime: @system.systemtime }
    end
  ...
  test "should update system" do
    patch :update, id: @system, system: { maxoutputdevice: @system.maxoutputdevice, systemode: @system.systemode, systemtime: @system.systemtime }
    assert_redirected_to system_path(assigns(:system))
  end
